...
This file provides guidance for OpenCode agents working with this YNAB MCP server repository.
...
## Testing Notes
- Tests use Vitest with mocking for the YNAB API
- Follow the pattern in existing test files for mocking API responses
- Test both success and error cases
- Test edge cases like empty responses and special characters
...
- `src/tests/` - Test files for each tool
